...
python do_swuimage_append() {
    ...
    image_path = os.path.join(imgdeploydir, image_name)
    ...
    shutil.copyfile(os.path.join(workdir, "manifest.json"), os.path.join(imgdeploydir, d.getVar('IMAGE_NAME', True) + "-manifest.json"))
